  ...
  return (
    <div className="flex h-8 items-center gap-6 border-b border-border bg-card/40 px-5">
      ...
      <div className="flex items-center gap-4 font-mono text-[11px]">
        ...
        <span className={pending > 0 ? "text-risk-medium" : "text-muted-foreground/50"}>
          pending{" "}
          <span className={`font-bold ${pending > 0 ? "" : "text-muted-foreground/40"}`}>
            {pending}
          </span>
        </span>
        ...
        <span className={highRisk > 0 ? "text-risk-high" : "text-muted-foreground/50"}>
          high-risk{" "}
          <span className={`font-bold ${highRisk > 0 ? "" : "text-muted-foreground/40"}`}>
            {highRisk}
          </span>
        </span>
        ...
        <span className="text-muted-foreground/50">
          resolved{" "}
          <span className={`font-bold ${resolved > 0 ? "text-risk-low" : "text-muted-foreground/40"}`}>
            {resolved}
          </span>
        </span>
      </div>
      ...
      <div className="ml-auto flex items-center gap-2 font-mono text-[10px] text-muted-foreground/40">
